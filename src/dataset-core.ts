// Browser-safe dataset core: analyze in-memory rows / text into a Dataset.
// No Node built-ins so this can be bundled for the browser. File-path input
// (buildDataset) lives in dataset.ts.
import { analyzeColumn, coerce, inferType } from "./analyze.js";
import type { ColType, Dataset, Row } from "./types.js";
import { parseText, type Format, type ParseOptions } from "./parse-core.js";
 ...
 * (csv/tsv/json/ndjson). Used for piped stdin input and the browser playground.
 */
